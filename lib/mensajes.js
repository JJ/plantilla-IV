...
exports.generarResumen = (tituloStatus, tituloMsg, cuerpoStatus, cuerpoMsg) => {
  ...
  if (tituloStatus === 'ERROR' || cuerpoStatus === 'ERROR') {
    lines.push('Se han encontrado errores. Consulta las instrucciones de entrega: https://jj.github.io/IV/documentos/proyecto/0.Repositorio#entrega-de-la-pr%C3%A1ctica');
    lines.push('');
    lines.push('Uno o más checks fallaron.');
  } else {
